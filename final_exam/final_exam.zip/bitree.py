...
class PrefixToString(BiTreeAlgo):
    ...
    def non_empty_case(self, data_node, inp):
        return f"{data_node.get_data()}({data_node.get_left().execute(self)}, {data_node.get_right().execute(self)})"
...
class PostfixToString(BiTreeAlgo):
    ...
    def non_empty_case(self, data_node, inp):
        return f"{data_node.get_left().execute(self)} {data_node.get_right().execute(self)}{data_node.get_data()}"
